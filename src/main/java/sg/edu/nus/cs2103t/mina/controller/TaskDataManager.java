...
public class TaskDataManager {
    ...
    private TreeSet<EventTask> _eventTreeSet = new TreeSet<EventTask>();
  	...
  	private TreeSet<TodoTask> _compTodoTasks = new TreeSet<TodoTask>();;
		private TreeSet<DeadlineTask> _compDeadlineTasks = new TreeSet<DeadlineTask>();
  	private TreeSet<EventTask> _compEventTasks = new TreeSet<EventTask>();;
