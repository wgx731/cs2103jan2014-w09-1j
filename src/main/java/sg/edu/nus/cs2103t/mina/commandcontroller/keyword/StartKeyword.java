...
public class StartKeyword extends Keyword {
    ...
    static {
        ...
        KeywordFactory.addAliasEntry(SimpleKeyword.START.getFormattedKeyword(), startPrototype);
    ...
    protected void initValues() {
        ...
        _startValues.put("^next\\smonth", today.plus(NO_YEAR, ONE_MONTH, NO_DAY,
                NO_HOUR, NO_MIN, NO_SEC, NO_NANO_SEC, DayOverflow.Spillover));
        _startValues.put("^next\\sweek", today.plus(NO_YEAR, NO_MONTH, ONE_WEEK,
                NO_HOUR, NO_MIN, NO_SEC, NO_NANO_SEC, DayOverflow.Spillover));
    ...
    public ArrayList<String> processKeyword(ArrayList<String> tokens,
        ...
        logger.info("Looking ahead: " + lookahead);
        ...
        if(hasJoinedDateTime(lookahead)) {
            ...
            logger.info(lookahead + " is not joint datetime");
        }
        ...
        if(rawTime==null) {
            logger.info("No time at first token, Getting date first");
            ...
            logger.info("Time found at first token, Getting date first");
    ...
    private String getJointDateTime(String dateTime) throws ParseException {
        ...
        SimpleDateFormat milDateTime = new SimpleDateFormat(DateUtil.MILITARY_DATE_FORMAT + DateUtil.MILITARY_TIME_FORMAT);
    ...
    private void checkValidDateTime(String rawDate, String rawTime) throws ParseException{
    ...
    private String convertDatePharseToDate(String rawDate) {
        ...
        if (isParseable && converted==null) {
            ...
            return converted.format(DateUtil.MILITARY_DATE_FORMAT.toUpperCase());
        } else {
            return null;
        }
    }
    ...
    private String processDateWithValue(String properPhrase) {
        ...
        Pattern valuePattern = Pattern.compile(valueRegex, Pattern.CASE_INSENSITIVE);
        ...
        logger.info("From date with value: " + dateValue);
        ...
        if(dateType.startsWith("day")) {
            advancedDate = advancedDate.plus(NO_YEAR, NO_MONTH, advancedValue, NO_HOUR, NO_MIN, NO_SEC, NO_NANO_SEC, DateTime.DayOverflow.Spillover);
        } else if(dateType.startsWith("month")) {
            advancedDate = advancedDate.plus(NO_YEAR, advancedValue, NO_DAY, NO_HOUR, NO_MIN, NO_SEC, NO_NANO_SEC, DateTime.DayOverflow.Spillover);
        } else if(dateType.startsWith("week")) {
            advancedDate = advancedDate.plus(NO_YEAR, NO_MONTH, advancedValue*7, NO_HOUR, NO_MIN, NO_SEC, NO_NANO_SEC, DateTime.DayOverflow.Spillover);
        } else if(dateType.startsWith("year")) {
            advancedDate = advancedDate.plus(advancedValue, NO_MONTH, NO_DAY, NO_HOUR, NO_MIN, NO_SEC, NO_NANO_SEC, DateTime.DayOverflow.Spillover);
        } else {
            return null;
        }
    ...
    private String getMilitaryTime(String rawTime) throws ParseException {
        ...
        logger.info("Getting military time: " + rawTime);
    ...
    private String parseDateFromRest(String lookahead, String rawTime) throws ParseException {
        String lookaheadRest = getLookaheadRest(lookahead, rawTime);
        return parseDateFirst(lookaheadRest);
    }

    private String parseTimeFromRest(String lookahead, String rawDate) throws ParseException {
        
        logger.info("Lookahead: " + lookahead + " rawDate: " + rawDate);
        String lookaheadRest = getLookaheadRest(lookahead, rawDate);
        logger.info("Trimmed Lookahead: " + lookaheadRest);
    ...
    private String parseDateFirst(String lookahead) throws ParseException{
        ...
        logger.info("Candidate: " + dateCandidate + "|");
    ...
    private String parseTimeFirst(String lookahead) throws ParseException {
        ...
        logger.info("parseTimeFirst lookahead: " + lookahead + "|");
        String firstToken = getFirstToken(lookahead);
        logger.info("Getting time first token: " + firstToken + "|");
