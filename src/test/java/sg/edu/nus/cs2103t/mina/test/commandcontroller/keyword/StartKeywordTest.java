...
public class StartKeywordTest {
    ...
    private static String timeOnlyControl, dateOnlyControl, timeDateControl, dateTimeControl;
    private static String timeResultContol, dateResultControl;
    
    private static String dateWordOnlyControl, dateWordTimeControl, timeDateWordControl;
    
    private static Logger logger = LogManager.getLogger(StartKeywordTest.class
            .getName());
    ...
    public void testTimeOnly() throws ParseException {
        ...
        assertEquals(expected, argument.getKeywordValue(SimpleKeyword.START).trim());
    }
